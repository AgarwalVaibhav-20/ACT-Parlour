...
const services = [
  {
    title: "Bridal Makeup",
    description: "Exquisite bridal looks tailored for your special day, from traditional to contemporary.",
    icon: Sparkles,
    image: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=800&auto=format&fit=crop",
  },
  {
    title: "Hair Styling",
    description: "Professional cuts, coloring, and styling to give you the perfect look for any occasion.",
    icon: Scissors,
    image: "https://images.unsplash.com/photo-1562322140-8baeececf3df?q=80&w=800&auto=format&fit=crop",
  },
  {
    title: "Facials & Skincare",
    description: "Rejuvenating treatments designed to nourish your skin and restore its natural glow.",
    icon: Flower2,
    image: "https://images.unsplash.com/photo-1570172619235-d39d757d58ae?q=80&w=800&auto=format&fit=crop",
  },
  {
    title: "Party Makeup",
    description: "Stunning makeup looks for parties, events, and celebrations that make you stand out.",
    icon: Star,
    image: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?q=80&w=800&auto=format&fit=crop",
  },
  {
    title: "Manicure & Pedicure",
    description: "Pamper your hands and feet with our relaxing and professional nail care services.",
    icon: Heart,
    image: "https://images.unsplash.com/photo-1610991148667-958010ce3646?q=80&w=800&auto=format&fit=crop",
  },
  {
    title: "Waxing & Threading",
    description: "Gentle and effective hair removal services for smooth and beautiful skin.",
    icon: Zap,
